...
# === WEHTTAMSNAPS WELCOME APPLICATION ===
# GitHub: https://github.com/Crowdrocker
# Professional Arch Linux Hyprland Setup Welcome
...
class WelcomeWindow:
    ...
    def add_welcome_image(self, container):
        ...
        image_path = os.path.join(
            home_dir, ".config", "wehttamsnaps", "assets", "logos", "ws-logo.png"
        )
    ...
    def add_main_text(self, container):
        ...
        text_content_parts = [
            ...
            "WehttamSnaps is a professional Arch Linux Hyprland configuration optimized for gaming, photography, and productivity. Built with Noctalia shell, Ghostty terminal, and comprehensive gaming optimizations.\n\n",
            "🚀 QUICK START\n\n",
            "While you can use the application launcher, keyboard shortcuts are the heart of WehttamSnaps:\n\n",
            "Essential Shortcuts:\n",
            "• SUPER + H      →  Show this help screen\n",
            ...
            "• SUPER + M      →  Theme Switcher\n",
            "• SUPER + SHIFT + G → Toggle Gamemode\n",
            "• SUPER + V      →  Clipboard Manager\n\n",
            "🎮 GAMING SETUP\n\n",
            "WehttamSnaps includes optimizations for:\n",
            "• AMD RX 580 and NVIDIA GTX 1650+ GPUs\n",
            "• Steam with Proton GE\n",
            "• Gamescope for enhanced performance\n",
            "• Fixed crashes for Division 2 and Cyberpunk 2077\n",
            ...
            "• RawTherapee for advanced RAW editing\n\n",
            "🎨 CUSTOMIZATION\n\n",
            "WehttamSnaps respects your abilities while providing an intuitive experience. Everything is configurable, and you're encouraged to make it your own.\n\n",
            "Enjoy exploring your new professional environment! 🔥\n",
        ]
...
def main():
    ...
    * {
    ...
    button {
        background: rgba(122, 162, 247, 1.0);
        color: #1a1b26;
        border: none;
        border-radius: 8px;
        padding: 8px 16px;
    ...
    button:hover {
        background: rgba(153, 177, 250, 1.0);
    }
